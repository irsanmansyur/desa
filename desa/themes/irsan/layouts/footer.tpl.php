...
<footer class="footer footer-three">
    ...
    <div class="container">
      ...
      <div class="row">
              ...
              <?php foreach ($w_gal as $data) { ?>
                <?php if (is_file(LOKASI_GALERI . "sedang_" . $data['gambar'])) { ?>
                  <li data-thumb="<?php echo AmbilGaleri($data['gambar'], 'sedang') ?>">
                    <a href='<?php echo site_url("home/sub_gallery/$data[id]"); ?>' title="<?php echo "Album : $data[nama]" ?>">
        ...
        <div class="col-md-6">
          ...
          <?php
          $mapsz = $this->db->query("SELECT * FROM widget WHERE id='14' ORDER BY id limit 1");
          foreach ($mapsz->result() as $rowmaps) {
            include("desa-app/views/widgets/" . trim($rowmaps->isi));
          }
          ?>
  ...
  <div class="secondary-footer brand-bg">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <span class="copy-text">&copy; 2019 | &nbsp; Desa Mappilawing | &nbsp; Partner of <a style="color: #fff;font-weight: bold;" href="https://www.facebook.com/ichank00" target="_blank"> Pemuda Mappilawing</a></span>
        </div><!-- /.col-md-6 -->
        <div class="col-md-4">
