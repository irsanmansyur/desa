<?php  if(!defined('BASEPATH')) exit('No direct script access allowed'); ?>
		...
		<script src="<?= base_url()?>assets/front/js/jquery.js"></script>
    	    ...
    	    <meta property="og:url" content="<?php echo base_url()?>index.php/home/artikel/<?php echo $single_artikel['id'];?>"/>
        ...
        <link href="<?php echo THEMES_PATH.$this->theme_folder.'/'.$this->theme.'/'; ?>assets/css/style.css" rel="stylesheet">
