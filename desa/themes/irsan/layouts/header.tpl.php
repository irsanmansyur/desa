                ...
                <div class="container">
                    ...
                    <div class="search-wrapper">
                        ...
                        <div class="search-form-wrapper">
                            <form method="get" action="<?php echo site_url('home');?>" class="white-form">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <!--logo start-->
                        <a href="<?php echo site_url(); ?>home/" class="logo-brand">
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <li><a href="javascript:void(0)">Kategori</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="<?php echo site_url()."home/kategori/".$sub['id']?>"><?php echo $sub['nama']; ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </li>
                            ...
                            <?php }else{ ?>
                              <li><a href="#"><b>Mandiri</b></a>
                                  <ul class="dropdown">
                                  	<li><a href="<?php echo site_url();?>home/mandiri/1/1"><i class="fa fa-user"></i> &nbsp;&nbsp; Profil Pengguna</a></li>
                                      <li><a href="<?php echo site_url();?>home/mandiri/1/2"><i class="fa fa-file"></i> &nbsp;&nbsp; Semua Layanan</a></li>
                                      <li><a href="<?php echo site_url();?>home/mandiri/1/3"><i class="fa fa-comment"></i> &nbsp;&nbsp; Lapor Pengaduan</a></li>
                                      <li><a href="<?php echo site_url();?>home/mandiri/1/4"><i class="fa fa-gift"></i> &nbsp;&nbsp; Daftar Bantuan</a></li>
                                      <li><a href="<?php echo site_url();?>home/logout"><i class="fa fa-sign-out"></i> &nbsp;&nbsp; Keluar</a></li>
                                  </ul>
                              </li>
                        	<?php } ?>
                        </ul>
