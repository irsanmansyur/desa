              ...
              <footer class="entry-footer">
                <div class="post-tags">
                  <span class="tags-links">
                    <i class="fa fa-tags"></i> <a href="<?php echo site_url('home/kategori/' . $single_artikel['id_kategori']) ?>"><?php echo $single_artikel['kategori'] ?></a>
                  </span>
                </div> <!-- .post-tags -->

                <ul class="list-inline right share-post">
                  <li><a name="fb_share" href="http://www.facebook.com/sharer.php?u=<?php echo site_url() . 'home/artikel/' . $single_artikel['id'] ?>" target="_blank"><i class="fa fa-facebook"></i> <span>Share</span></a>
                  </li>
                  <li><a href="http://twitter.com/share?url=<?php echo site_url() . 'home/artikel/' . $single_artikel['id'] ?>" target="_blank"><i class="fa fa-twitter"></i> <span>Tweet</span></a>
                  </li>
                  <li><a href="https://plus.google.com/share?url=<?php echo site_url() . 'home/artikel/' . $single_artikel['id'] . '&hl=id' ?>" target="_blank"><i class="fa fa-google-plus"></i> <span>Plus</span></a>
                  </li>
                </ul>
              </footer>
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane fade in active" id="default-comment">
                        <div class="comment-respond">
                          ...
                          <?php endif; ?>
                          <form id="form-komentar" name="form" action="<?php echo site_url('home/add_comment/' . $single_artikel['id']) ?>" method="POST" onSubmit="return validasi(this);">
                      ...
                      <!-- <div role="tabpanel" class="tab-pane fade" id="facebook-comment">
                                                        <p>
                                    	                    <div class="fb-comments" data-href="<?php echo site_url() . 'home/artikel/' . $single_artikel['id'] ?>" data-width="100%" data-numposts="10">
                                    		                    <div placeholder>
											                        <div class="loading">
