...
<section class="rev_slider_wrapper">
  <div class="rev_slider materialize-slider slider-style">
    <ul>
      <?php foreach ($slider_gambar['gambar'] as $gambar) : ?>
        ...
        <?php if (is_file($slider_gambar['lokasi'] . 'sedang_' . $gambar['gambar'])) : ?>
          ...
          <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="<?php echo base_url() . $slider_gambar['lokasi'] . 'sedang_' . $gambar['gambar'] ?>" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Unique Design" data-description="">
            ...
            <div class="tp-caption large_text skewfromrightshort fadeout" data-x="85" data-y="224" data-speed="500" data-start="1200" data-easing="Power4.easeOut"><?php echo $gambar['judul']; ?>
            </div>
            <div class="tp-caption tp-resizeme rev-subheading text-center" data-x="center" data-y="center" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:600;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on" style="z-index: 6; white-space: nowrap;font-size: 28px;"><?php echo $gambar['judul']; ?>
            </div>
            ...
            <div class="tp-caption tp-resizeme rev-btn" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['100','100','100','100']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-style_hover="cursor:default;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:600;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1200" data-splitin="none" data-splitout="none" data-responsive_offset="on" style="z-index: 7; white-space: nowrap;">
              <!-- <a href="<?php echo site_url('home/artikel/') . $gambar['id']; ?>" class="btn btn-lg  waves-effect waves-light">Explore More</a> -->
            </div>
          </li>
        <?php endif; ?>
  ...
  <div class="container">
    <div class="featured-carousel">
      ...
      foreach ($mnu->result() as $num => $datam) :
        ?>
        <a href="<?php echo site_url('home/') . $datam->link; ?>">
  ...
  <div class="container">
                ...
                <div class="blog-content">
                  ...
                  <header class="entry-header-wrapper">
                    <div class="entry-header">
                      <h2 class="entry-title"><a href="<?php echo site_url('home/artikel/') . $data['id']; ?>"><?php echo $data['judul']; ?></a></h2>
                      ...
                      <div class="entry-meta">
                        <ul class="list-inline">
                          ...
                          <li>
                            In <a href="<?php echo site_url('home/kategori/') . $data['id_kategori']; ?>"><?php echo $data['kategori']; ?></a>
                          </li>
                        </ul>
                      </div><!-- .entry-meta -->
                    </div><!-- /.entry-header -->
    ...
    <ul class="pagination post-pagination text-center mt-50">
      ...
      if ($paging->start_link) {
        echo "<li><a href=\"" . site_url("home/" . $paging_page . "/$paging->start_link" . $paging->suffix) . "\" title=\"Halaman Pertama\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-double-left\"></i>&nbsp;</a></li>";
      }
      if ($paging->prev) {
        echo "<li><a href=\"" . site_url("home/" . $paging_page . "/$paging->prev" . $paging->suffix) . "\" title=\"Halaman Sebelumnya\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-left\"></i>&nbsp;</a></li>";
      }

      // for($i=$paging->start_link;$i<=$paging->end_link;$i++){
      // 	if ($p != $i) {
      // 		echo "<li><a href=\"".site_url("home/".$paging_page."/$i" . $paging->suffix)."\" title=\"Halaman ".$i."\"  class=\"waves-effect waves-light\">".$i."</a></li>";
      // 	}else{
      ...
      if ($paging->next) {
        echo "<li><a href=\"" . site_url("home/" . $paging_page . "/$paging->next" . $paging->suffix) . "\" title=\"Halaman Selanjutnya\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-right\"></i>&nbsp;</a></li>";
      }
      if ($paging->end_link) {
        echo "<li><a href=\"" . site_url("home/" . $paging_page . "/$paging->end_link" . $paging->suffix) . "\" title=\"Halaman Terakhir\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-double-right\"></i>&nbsp;</a></li>";
      }
      ?>
    </ul>
    ...
    <div class="seo-featured-carousel brand-dot">
      <?php foreach ($aparatur_desa as $data) : ?> 
        <div class="featured-item seo-service">
          <?php if (AmbilFoto($data['foto'], "besar") ): ?>
            <div class="icon">
              <img class="img-responsive img-aparat" src="<?php echo AmbilFoto($data['foto'], "besar") ?>" alt="<?php echo $data['pamong_nama'] ?>" class="">
            </div>
          <?php endif; ?>
          <div class="desc" style="background: transparent;text-align: center;">
            <h2><?php echo !empty($data['pamong_nama']) ? $data['pamong_nama'] :$data['nama'] ?></h2>
