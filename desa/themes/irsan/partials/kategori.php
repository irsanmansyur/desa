            ...
            <div class="container">
              ...
              <ul class="pagination post-pagination text-center mt-50">
              	...
              	if($paging->start_link){
					echo "<li><a href=\"".site_url("home/".$paging_page."/$paging->start_link" . $paging->suffix)."\" title=\"Halaman Pertama\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-left\"></i>&nbsp;</a></li>";
				}
				if($paging->prev){
				...
				if($paging->end_link){
					echo "<li><a href=\"".site_url("home/".$paging_page."/$paging->end_link" . $paging->suffix)."\" title=\"Halaman Terakhir\" class=\"waves-effect waves-light\"><i class=\"fa fa-angle-right\"></i>&nbsp;</a></li>";
				}
				?>
              </ul>
