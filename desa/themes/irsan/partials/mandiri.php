...
<div class="artikel layanan">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form">
    <tr>
	  ...
	  <tr>
		  <td colspan="3" class="button" scope="col"><a href="<?php echo site_url("home/cetak_kk/$penduduk[id]/1"); ?>" target="_blank"><button type="button" class="waves-effect waves-light btn"><i class="fa fa-print"></i> CETAK KARTU KELUARGA</button></a></td>
    </tr>
  </table>
  <br />
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form" >
    ...
    <tr>
      <td colspan="3" class="button" scope="col"><a href="<?php echo site_url("home/cetak_biodata/$penduduk[id]"); ?>" target="_blank"><button type="button" class="waves-effect waves-light btn"><i class="fa fa-print"></i> CETAK BIODATA</button></a></td>
    </tr>
  </table>
  <br />
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered form">
    <thead>
      <tr>
        <th style="text-align: center;vertical-align: middle;" colspan="4" class="judul" scope="col"><b>KEANGGOTAAN KELOMPOK</b></th>
      </tr>
      <tr>
        <th style="text-align: center;vertical-align: middle;" width="2">No</th>
        <th style="text-align: center;vertical-align: middle;" width="220">Nama Kelompok</th>
        <th style="text-align: center;vertical-align: middle;" width="360">Kategori Kelompok</th>
        <th> &nbsp;</th>
      </tr>
    </thead>
    <tbody>  
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered">
    <thead>
      <tr>
        <th style="text-align: center;vertical-align: middle;" colspan="5" class="judul" scope="col"><b>DOKUMEN / KELENGKAPAN PENDUDUK</b></th>
      </tr>
      <tr> 
        <th style="text-align: center;vertical-align: middle;" width="2">No</th>
        <th style="text-align: center;vertical-align: middle;" width="220">Nama Dokumen</th>
        <th style="text-align: center;vertical-align: middle;" width="360">Berkas</th>
        <th style="text-align: center;vertical-align: middle;" width="200">Tanggal Upload</th>
        <th>&nbsp;</th>
      </tr>
    </thead>
    <tbody>
