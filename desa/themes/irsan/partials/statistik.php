	...
	<div class=\"box box-danger\">
		<div class=\"box-header with-border\">
			<div class=\"box-tools pull-right\">
				<div class=\"btn-group\">";
					$strC = ($tipe==1)? "indigo":"";
					echo "<a href=\"".site_url("home/statistik/$st/1")."\" class=\"waves-effect waves-light btn ".$strC."\">Bar Graph</a>";
					$strC = ($tipe==0)? "indigo":"";
					echo "<a href=\"".site_url("home/statistik/$st/0")."\" class=\"waves-effect waves-light btn ".$strC."\">Pie Cart</a>
				</div>
			</div>
		</div>
		<div class=\"box-body\">
