...
<body id="top" class="has-header-search">
    ...
    <!-- Top bar start -->
    <?php if ($jml != 0 || $jmlSTK != 0) {
        $this->load->view($folder_themes . '/layouts/topbar.tpl.php');
    } ?>
    <!-- Top bar end -->

    <!--header start-->
    <?php if ($jml != 0 || $jmlSTK != 0) {
        $this->load->view($folder_themes . '/layouts/header.tpl.php');
    } ?>
    <!--header end-->
    ...
    <!-- footer start -->
    <?php if ($jml != 0 || $jmlSTK != 0) {
        $this->load->view($folder_themes . '/layouts/footer.tpl.php');
    } ?>
    <!-- footer end -->
